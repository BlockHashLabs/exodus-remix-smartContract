...
contract ExodusBondDepositoryV2 is IBondDepository, NoteKeeper {
    /* ======== DEPENDENCIES ======== */
    ...
    constructor(
        IExodusAuthority _authority,
        IERC20 _exo,
        IgEXO _gexo,
        IStaking _staking,
        ITreasury _treasury
    ) NoteKeeper(_authority, _exo, _gexo, _staking, _treasury) {
        // save gas for users by bulk approving stake() transactions
        _exo.approve(address(_staking), 1e45);
    }
