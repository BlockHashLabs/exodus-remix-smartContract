...
import "./IExodusAuthority.sol";

import "./ExodusAccessControlled.sol";

contract ExodusAuthority is IExodusAuthority, ExodusAccessControlled {
    /* ========== STATE VARIABLES ========== */
    ...
    constructor(
        ...
        address _policy,
        address _vault
    ) ExodusAccessControlled(IExodusAuthority(address(this))) {
        governor = _governor;
